...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/trelairpark>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/trelairpark")]])
    )
...
async def next_page(bot, query):
    ...
    #     ]
        ...
        btn.insert(0, [
            InlineKeyboardButton(" ‼️ ᴄʜᴇᴄᴋ ʙᴏᴛ ᴘᴍ ‼️", url=f"https://telegram.me/{temp.U_NAME}")
        ])
    else:
        btn = []
    try:
...
async def languages_cb_handler(client: Client, query: CallbackQuery):
    ...
    btn.insert(
        ...
        [
            InlineKeyboardButton(
                text="👇 sᴇʟʟᴇᴄᴛ ʏᴏᴜʀ ʟᴀɴɢᴜᴀɢᴇ 👇", callback_data="ident"
            )
        ],
    )
...
async def seasons_cb_handler(client: Client, query: CallbackQuery):
    ...
    btn.insert(
        ...
        [
            InlineKeyboardButton(
                text="👇 sᴇʟʟᴇᴄᴛ sᴇᴀsᴏɴ 👇", callback_data="ident"
            )
        ],
    )
    req = query.from_user.id
...
async def filter_seasons_cb_handler(client: Client, query: CallbackQuery):
    ...
    btn.insert(0, [
        InlineKeyboardButton("!! sᴇɴᴅ ᴀʟʟ !!", callback_data=f"sendfiles#{key}"),
        InlineKeyboardButton("♻️ ᴀɢᴀɪɴ ♻️", callback_data=f"seasons#{key}")
    ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                             [
                              InlineKeyboardButton('👥 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ 👥', url=SUPPORT_CHAT)
                            ]
                        )
                    )
                else:
        ...
        if settings is not None:
            buttons = [
                ...
                [
                    ...
                    InlineKeyboardButton('5 Mɪɴs' if settings["auto_delete"] else '❌',
                                         callback_data=f'setgs#auto_delete#{settings["auto_delete"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('Aᴜᴛᴏ-Fɪʟᴛᴇʀ',
                                         callback_data=f'setgs#auto_ffilter#{settings["auto_ffilter"]}#{str(grp_id)}'),
                    InlineKeyboardButton('✅' if settings["auto_ffilter"] else '❌',
                                         callback_data=f'setgs#auto_ffilter#{settings["auto_ffilter"]}#{str(grp_id)}')
                ],
                [
                ...
                [
                    ...
                    InlineKeyboardButton('✅' if settings["is_shortlink"] else '❌',
                                         callback_data=f'setgs#is_shortlink#{settings["is_shortlink"]}#{str(grp_id)}')
                ]
            ]
            reply_markup = InlineKeyboardMarkup(buttons)
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/trelairpark")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('❰ ʙᴀᴄᴋ', callback_data='start'),
            InlineKeyboardButton('🪴 ᴀᴅᴍɪɴ 🪴', callback_data='malik')
        ]]
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
        ...
        buttons = [[
            InlineKeyboardButton('📞 ᴄᴏɴᴛᴀᴄᴛ 🐍', url="https://t.me/Jita2021")
        ],[
            InlineKeyboardButton('❰ ʙᴀᴄᴋ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('🔮ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ🔮', url="https://t.me/trelairpark13")
        ],[
            InlineKeyboardButton('👥 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ 👥', url="https://t.me/trelairpark")
        ],[
            InlineKeyboardButton('❰ ʙᴀᴄᴋ', callback_data='start'),
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("🎥 ᴛᴜᴛᴏʀɪᴀʟ", url="https://t.me/MS_Mihir/26"),
                    InlineKeyboardButton("🤵ᴄᴏɴᴛᴀᴄᴛ", url="https://t.me/Jita2021")
                  ],[
                    InlineKeyboardButton("❰ ʙᴀᴄᴋ", callback_data="start")
                  ]]
...
async def auto_filter(client, msg, spoll=False):
    ...
    # else:
    if settings["button"]:
        cap = f"<b>✰ ғɪʟᴇs / ᴠɪᴅᴇᴏ ᴏғ ⊳ {search}\n\n✰ ᴀsᴋᴇᴅ ʙʏ ⊳ {message.from_user.mention}\n\n✰ ɢɪᴠᴇɴ ɪɴ ⊳ {remaining_seconds} sᴇᴄᴏɴᴅs\n\n✰ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ⊳ {message.chat.title} \n\n⚠️ ᴀꜰᴛᴇʀ 5 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ 🗑️\n\n</b>"
    else:
